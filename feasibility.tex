...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{Stowed}
    \caption{Conceptual drawing of CySat I in it's stowed configuration.}
\end{figure}

\begin{figure}[H]

    \includegraphics[width=\textwidth]{Deployed}
    \caption{Conceptual drawing of CySat I in it's deployed configuration.}
\end{figure}
...
\bibitem[Barriot]{Barriot} Barriot, J., et al, ``The Comet Nucleus Sounding Experiment by Radio-wave Transmission (CONSERT),'' Advances in Space Research, 1998.
...
\bibitem[Murchie]{Murchie} Murchie, S., et al, ``Compact Reconnaissance Imaging Spectrometer for Mars (CRISM) on Mars Reconnaissance Orbiter (MRO),'' Journal of Geophysical Research,  2007.
